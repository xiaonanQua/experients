...
#        self.hdf5_file.close()
    ...
    #     """
    #     Use this function when you're in Linux system.
    #     :return:
    #     """
    #     import matplotlib.pyplot as plt
    #     self.plt = plt
    #     """plot and save the figure for training process"""
    #     sli_index = 10000
    #     self.plt.clf()
    #     self.plt.figure(figsize=[15, 10])
    #     trial = self.log.index[:sli_index]
    #     correct_rate = self.log['correct_rate'][:sli_index]
    #     loss = self.log['loss'][:sli_index]

    #     self.plt.subplot(2, 1, 1)
    #     correct_rate.plot()
    #     self.plt.title('Training process', fontsize='x-large')
    #     self.plt.xlabel('Trial', fontsize='x-large')
    #     self.plt.ylabel('Correct rate', fontsize='x-large')
    #     self.plt.ylim(0, 1)
    #     self.plt.subplot(2, 1, 2)

    #     loss.plot()
    #     self.plt.xlabel('Trial', fontsize='x-large')
    #     self.plt.ylabel('Loss', fontsize='x-large')
    #     self.plt.ylim(0, 1)
    #     self.plt.savefig(self.fig_path + "training.png")
    #     self.plt.show()
